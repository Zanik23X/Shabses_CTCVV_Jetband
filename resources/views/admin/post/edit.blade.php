            ...
            <div class="card-body">
                ...
                <form action="{{ url('admin/update-post/'. $post->id) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="meta_description" class="form-control" rows="3" >value="{!! $post->meta_description !!}"</textarea>
                    </div>

                    <div class="mb-3">
                        <label for="">Meta Keyword</label>
                        <textarea name="meta_keyword" class="form-control" rows="3">value="{!! $post->meta_keyword !!}"</textarea>
                    </div>
